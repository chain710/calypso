...
BINARY = demo
demo_dep = demo_app.o calypso.o allocator.o netlink.o netlink_config.o \
        calypso_network.o calypso_interface.o calypso_bootstrap_config.o \
        calypso_runtime_config.o calypso_signal.o utility.o ring_queue.o timer_engine.o
